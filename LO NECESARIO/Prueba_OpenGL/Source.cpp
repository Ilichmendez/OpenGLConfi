...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Puto el que lo lea", NULL, NULL);
	...
	glm::vec3 lightPos = glm::vec3(0.f, -0.f, 0.5f);
	glm::mat4 lightModel = glm::mat4(1.0f);
	lightModel = glm::translate(lightModel, lightPos);

	glm::vec4 lightColor1 = glm::vec4(0.0f, 0.0f, 1.0f, 1.0f);
	glm::vec3 lightPos1 = glm::vec3(0.f,-10.f, -10.5f);
	...
	glUniform4f(glGetUniformLocation(lightShader.ID, "lightColor1"), lightColor1.x, lightColor1.y, lightColor1.z, lightColor1.w);
	glUniformMatrix4fv(glGetUniformLocation(lightShader.ID, "model1"), 1, GL_FALSE, glm::value_ptr(lightModel1));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Tells OpenGL which Shader Program we want to use for the main object
		shaderProgram.Activate();
		...
		// Render the first light cube
		lightShader.Activate();
		// Export the camMatrix to the Vertex Shader of the light cube
		camera.Matrix(lightShader, "camMatrix");
		// Set the model matrix and light color for the first light
		glUniformMatrix4fv(glGetUniformLocation(lightShader.ID, "model"), 1, GL_FALSE, glm::value_ptr(lightModel));
		glUniform4f(glGetUniformLocation(lightShader.ID, "lightColor"), lightColor.x, lightColor.y, lightColor.z, lightColor.w);
		lightVAO.Bind();
