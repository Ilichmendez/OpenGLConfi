...
int main()
{
	...
	unsigned char* bytes = stbi_load("kirby.png", &widthImg, &heightImg, &numColCh, 0);
	GLuint texture;
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, widthImg, heightImg, 0, GL_RGBA, GL_UNSIGNED_BYTE, bytes); //png
	//glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, widthImg, heightImg, 0, GL_RGB, GL_UNSIGNED_BYTE, bytes);	   //jpg o png sin alpha
